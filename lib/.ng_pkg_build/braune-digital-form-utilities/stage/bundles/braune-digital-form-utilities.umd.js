(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs/Subject'), require('@angular/forms'), require('ngx-bootstrap'), require('ng2-ckeditor'), require('@angular/common/http'), require('rxjs/add/operator/do'), require('rxjs/util/noop'), require('@angular/platform-browser'), require('@angular/common'), require('@ng-select/ng-select'), require('@ngx-translate/core'), require('ngx-bootstrap/datepicker'), require('ngx-bootstrap/timepicker'), require('ngx-quill')) :
	typeof define === 'function' && define.amd ? define('@braune-digital/form-utilities', ['exports', '@angular/core', 'rxjs/Subject', '@angular/forms', 'ngx-bootstrap', 'ng2-ckeditor', '@angular/common/http', 'rxjs/add/operator/do', 'rxjs/util/noop', '@angular/platform-browser', '@angular/common', '@ng-select/ng-select', '@ngx-translate/core', 'ngx-bootstrap/datepicker', 'ngx-bootstrap/timepicker', 'ngx-quill'], factory) :
	(factory((global['braune-digital'] = global['braune-digital'] || {}, global['braune-digital']['form-utilities'] = {}),global.ng.core,global.Rx,global.ng.forms,global.ngxBootstrap,global.ng2Ckeditor,global.ng.common.http,global.Rx.Observable.prototype,global.Rx.noop,global.ng.platformBrowser,global.ng.common,global.ngSelect,global.core$1,global.datepicker,global.timepicker,global.ngxQuill));
}(this, (function (exports,core,Subject,forms,ngxBootstrap,ng2Ckeditor,http,_do,noop,platformBrowser,common,ngSelect,core$1,datepicker,timepicker,ngxQuill) { 'use strict';
...
FormInputComponent.propDecorators = {
    "displayErrors": [{ type: core.Input },],
    "requiredMarker": [{ type: core.Input },],
...
var FormErrorService = /** @class */ (function () {
    function FormErrorService() {
        ...
        this.formError = new Subject.Subject();
    }
...
var InputComponent = /** @class */ (function (_super) {
    ...
    function InputComponent(_options, formErrorService) {
        ...
        _this.onInputKeypress = new core.EventEmitter();
        _this.onInputChange = new core.EventEmitter();
        _this.onInputKeyup = new core.EventEmitter();
        _this.onFocus = new core.EventEmitter();
        _this.onFocusOut = new core.EventEmitter();
        return _this;
    }
...
InputComponent.propDecorators = {
    ...
    "onInputKeypress": [{ type: core.Output },],
    "onInputChange": [{ type: core.Output },],
    "onInputKeyup": [{ type: core.Output },],
...
var DatepickerComponent = /** @class */ (function (_super) {
    ...
    function DatepickerComponent(_options, formErrorService, langService) {
        ...
        _this.placeholder = '';
        _this.disableErrors = false;
        _this.bsConfig = new ngxBootstrap.BsDatepickerConfig();
        _this.bsLang = 'en';
...
DatepickerComponent.propDecorators = {
    ...
    "bsLang": [{ type: core.Input },],
    "bsMaxDate": [{ type: core.Input },],
    "bsMinDate": [{ type: core.Input },],
    "datepicker": [{ type: core.ViewChild, args: ['dp',] },],
};
...
DaterangeComponent.propDecorators = {
    ...
    "bsMaxDate": [{ type: core.Input },],
    "bsMinDate": [{ type: core.Input },],
    "daterange": [{ type: core.ViewChild, args: ['dp',] },],
};
...
CkeditorComponent.propDecorators = {
    "input": [{ type: core.ViewChild, args: [forms.DefaultValueAccessor,] },],
    "editor": [{ type: core.ViewChild, args: [ng2Ckeditor.CKEditorComponent,] },],
    "ckeditorConfig": [{ type: core.Input },],
    "inputClass": [{ type: core.Input },],
    "label": [{ type: core.Input },],
    "placeholder": [{ type: core.Input },],
    "disableErrors": [{ type: core.Input },],
...
ProgressButtonComponent.propDecorators = {
    ...
    "btnType": [{ type: core.Input },],
    "btnStateLoading": [{ type: core.Input },],
    "btnStateSuccess": [{ type: core.Input },],
    "btnDisabled": [{ type: core.Input },],
};
...
AutosizeDirective.propDecorators = {
    "resize": [{ type: core.HostListener, args: ['input',] }, { type: core.HostListener, args: ['load',] },],
};
...
var CheckboxComponent = /** @class */ (function (_super) {
    ...
    function CheckboxComponent(_options, formErrorService) {
        ...
        _this.onTouchedCallback = noop.noop;
        _this.onChangeCallback = noop.noop;
        return _this;
    }
...
CheckboxComponent.propDecorators = {
    "input": [{ type: core.ViewChild, args: [forms.CheckboxControlValueAccessor,] },],
    "label": [{ type: core.Input },],
    "placeholder": [{ type: core.Input },],
    "inputClass": [{ type: core.Input },],
    "disableErrors": [{ type: core.Input },],
...
DatetimepickerComponent.propDecorators = {
    "dp": [{ type: core.ViewChild, args: [ngxBootstrap.DatePickerComponent,] },],
    "label": [{ type: core.Input },],
    "help": [{ type: core.Input },],
    "inputClass": [{ type: core.Input },],
    "placeholder": [{ type: core.Input },],
...
RteComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [{
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return RteComponent; }),
                        multi: true
                    }],
                selector: 'bd-rte',
...
MaxLengthDirective.propDecorators = {
    "counter": [{ type: core.HostListener, args: ['input',] }, { type: core.HostListener, args: ['load',] },],
};
...
exports.FormUtilitiesModule = FormUtilitiesModule;
exports.DefaultFormUtilitiesOptions = DefaultFormUtilitiesOptions;
exports.isEmail = isEmail;
exports.ɵd = CheckboxComponent;
exports.ɵe = DatetimepickerComponent;
exports.ɵb = FormInputComponent;
exports.ɵc = RteComponent;
exports.ɵm = FormAddonComponent;
exports.ɵl = FormCounterComponent;
exports.ɵh = FormErrorsComponent;
exports.ɵi = FormHelpComponent;
exports.ɵg = FormLabelComponent;
exports.ɵk = FormRequiredComponent;
exports.ɵj = FormTipsComponent;
exports.ɵf = MaxLengthDirective;
exports.ɵn = FormErrorInterceptor;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=braune-digital-form-utilities.umd.js.map
